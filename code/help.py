...
async def halp(ctx,set1,set2):
    ...
    if set1 == "game":
        game_desc = ["$start [time month=M day=D], starts a trading game in the channel that lasts for the duration specified or by default 7 days(EX: $start 1M, starts a month-long game) Everyone in the game by default starts with $100000",
        ...
        "$game, checks when the current game in the channel will end"
        ]
        names = [["Start"],["End"],["Join"],["Buy","B"],["Sell","S"],["Market","M"],["Leaderboard","Lb"],["Assets"],["Game"]]
